...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, fc1_dims=256, fc2_dims=256, chkpt_dir='checkpoint'):
        super(ActorNetwork, self).__init__()

        self.checkpoint_file = os.path.join(chkpt_dir, 'actor_chkpt_final')  
...
class CriticNetwork(nn.Module):
    def __init__(self, input_dims, fc1_dims=256, fc2_dims=256, chkpt_dir='checkpoint'):
...
class Agent:
    ...
    def remember(self, state, action, probs, value, reward, done):
        self.memory.store_memory(state, action, probs, value, reward, done)
